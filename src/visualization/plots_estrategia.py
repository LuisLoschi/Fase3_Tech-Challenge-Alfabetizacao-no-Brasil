...
unidade de negócio — estudantes, pontos percentuais, municípioss.
"""
...
def plotar_dois_rankings(ranking: pd.DataFrame, n: int = 20) -> Figure:
    ...
    diferentes: à esquerda a probabilidade média de um estudante não se
    alfabetizar, à direita quantos estudantes isso representa. Forçar o mesmo eixo
    ...
    eixos[1].set_xlabel("estudantes em risco na população estimada")
    eixos[1].set_title(f"Escala — os {n} municípios com mais estudantes em risco", loc="left")
