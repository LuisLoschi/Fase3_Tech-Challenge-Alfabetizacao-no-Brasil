...
def _coalescer(base: pd.DataFrame, prefixo: str, chave: str) -> pd.DataFrame:
    ...
    # A Gold sai em fração e o INEP publica em pontos percentuais; a coluna de
    # coalescência precisa de uma escala só, e a escolhida é a do INEP.
...
def montar_feature_store(
    ...
    Recebe as bases já carregadas para que o notebook e os testes não leiam duas
