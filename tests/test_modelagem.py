...
def test_calibracao_nao_reordena_e_nao_piora_o_brier(chaves):
    ...
    A calibração é uma tradução de escala, não um modelo. Se ela reordenasse
    os alunos, o baseline deixaria de ser a regra de uma variável e viraria um 
    modelo — e a comparação perderia o sentido. Se ela piorasse o Brier, a 
    isotônica não estaria cumprindo seu papel de melhorar a probabilidade.
    """
